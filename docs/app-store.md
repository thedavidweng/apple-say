...
- **Name:** Apple Say
- **Subtitle:** System voices, made simple
- **Primary category:** Utilities
- **Keywords:** text to speech,TTS,voice,audio,LRC,Personal Voice,speech,export
- **Support URL:** https://github.com/thedavidweng/apple-say/issues
- **Marketing URL:** https://github.com/thedavidweng/apple-say
- **Privacy Policy URL:** https://github.com/thedavidweng/apple-say/blob/main/PRIVACY.md
- **Copyright:** 2026 David Weng
...
- **副标题：** 轻松使用 Mac 系统声音
- **主要类别：** 工具
- **关键词：** 文本转语音,语音,音频,LRC,个人声音,朗读,导出,TTS
- **支持网址：** https://github.com/thedavidweng/apple-say/issues
- **营销网址：** https://github.com/thedavidweng/apple-say
- **隐私政策网址：** https://github.com/thedavidweng/apple-say/blob/main/PRIVACY.md
- **版权：** 2026 David Weng
- **App 隐私：** 不收集数据
- **加密：** 不使用需要申报的加密
